...
const Navbar = () => {
    return (
        <div class='flex-col lg:flex-row'>
            <nav class='bg-blue-500 relative flex lg:flex-col items-center justify-between p-3 lg:p-6 lg:py-12 lg:order-first'>
                ...
                <div class='flex grow lg:justify-between lg:flex-col lg:my-12 lg:px-3 lg:pb-12 lg:border-b-2 lg:border-white lg:border-opacity-10'>
                    <ul class='flex lg:flex-col items-center justify-between lg:justify-start gap-6 text-white/50 w-2/3 lg:w-auto mb-5'>
                ...
                <a href='#' class='w-10 h-10 rounded-lg overflow-hidden text-white hidden lg:block'>
